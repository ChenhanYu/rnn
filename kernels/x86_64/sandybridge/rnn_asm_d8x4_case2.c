    ...
    )
{
  ...
  double neg2 = -2.0;
	...
	"                                            \n\t"
	"                                            \n\t"
	"vshufpd    $0x0, %%ymm11, %%ymm9,  %%ymm0   \n\t"
	"vshufpd    $0xF, %%ymm11, %%ymm9,  %%ymm1   \n\t"
	"vshufpd    $0x0, %%ymm15, %%ymm13, %%ymm2   \n\t"
	"vshufpd    $0xF, %%ymm15, %%ymm13, %%ymm3   \n\t"
	"vshufpd    $0x0, %%ymm10, %%ymm8,  %%ymm4   \n\t"
	"vshufpd    $0xF, %%ymm10, %%ymm8,  %%ymm5   \n\t"
	"vshufpd    $0x0, %%ymm14, %%ymm12, %%ymm6   \n\t"
	"vshufpd    $0xF, %%ymm14, %%ymm12, %%ymm7   \n\t"
	"                                            \n\t"
	"                                            \n\t"
	"vperm2f128 $0x20, %%ymm2,  %%ymm0,  %%ymm8  \n\t"
	"vperm2f128 $0x31, %%ymm2,  %%ymm0,  %%ymm10 \n\t"
	"vperm2f128 $0x20, %%ymm3,  %%ymm1,  %%ymm9  \n\t"
	"vperm2f128 $0x31, %%ymm3,  %%ymm1,  %%ymm11 \n\t"
	"vperm2f128 $0x20, %%ymm6,  %%ymm4,  %%ymm12 \n\t"
	"vperm2f128 $0x31, %%ymm6,  %%ymm4,  %%ymm14 \n\t"
	"vperm2f128 $0x20, %%ymm7,  %%ymm5,  %%ymm13 \n\t"
	"vperm2f128 $0x31, %%ymm7,  %%ymm5,  %%ymm15 \n\t"
	"                                            \n\t"
	"                                            \n\t"
	"movq                  %10, %%rcx            \n\t" // load address of ctmp
	"                                            \n\t"
	"                                            \n\t"
	".DNOLOADC:                                  \n\t"
	"                                            \n\t"
	...
	"vmovapd           %%ymm10, 2 * 32(%%rcx)    \n\t" // C_c( 2, 0:3 ) = ymm10
	"vmovapd           %%ymm11, 3 * 32(%%rcx)    \n\t" // C_c( 3, 0:3 ) = ymm11
	"vmovapd           %%ymm12, 4 * 32(%%rcx)    \n\t" // C_c( 4, 0:3 ) = ymm12
	"vmovapd           %%ymm13, 5 * 32(%%rcx)    \n\t" // C_c( 5, 0:3 ) = ymm13
	"vmovapd           %%ymm14, 6 * 32(%%rcx)    \n\t" // C_c( 6, 0:3 ) = ymm14
	"vmovapd           %%ymm15, 7 * 32(%%rcx)    \n\t" // C_c( 7, 0:3 ) = ymm15
	"                                            \n\t"
	".DDONE:                                     \n\t"
	"                                            \n\t"
