    ...
    )
{
  ...
  for ( i = 0; i < k_iter; ++i ) {
    ...
    c_max.v = _mm256_max_pd( a03.v  , b0.v    );
    c_min.v = _mm256_min_pd( a03.v  , b0.v    );
    c_max.v = _mm256_sub_pd( c_max.v, c_min.v );
    c03_0.v = _mm256_add_pd( c_max.v, c03_0.v );

    c_max.v = _mm256_max_pd( a47.v  , b0.v    );
    c_min.v = _mm256_min_pd( a47.v  , b0.v    );
    c_max.v = _mm256_sub_pd( c_max.v, c_min.v );
    c47_0.v = _mm256_add_pd( c_max.v, c47_0.v );
    ...
    c_max.v = _mm256_max_pd( a03.v  , b1.v    );
    c_min.v = _mm256_min_pd( a03.v  , b1.v    );
    c_max.v = _mm256_sub_pd( c_max.v, c_min.v );
    c03_1.v = _mm256_add_pd( c_max.v, c03_1.v );

    c_max.v = _mm256_max_pd( a47.v  , b1.v    );
    c_min.v = _mm256_min_pd( a47.v  , b1.v    );
    c_max.v = _mm256_sub_pd( c_max.v, c_min.v );
    c47_1.v = _mm256_add_pd( c_max.v, c47_1.v );
    ...
    c_max.v = _mm256_max_pd( a03.v  , b2.v    );
    c_min.v = _mm256_min_pd( a03.v  , b2.v    );
    c_max.v = _mm256_sub_pd( c_max.v, c_min.v );
    c03_2.v = _mm256_add_pd( c_max.v, c03_2.v );

    c_max.v = _mm256_max_pd( a47.v  , b2.v    );
    c_min.v = _mm256_min_pd( a47.v  , b2.v    );
    c_max.v = _mm256_sub_pd( c_max.v, c_min.v );
    c47_2.v = _mm256_add_pd( c_max.v, c47_2.v );

    // Shuffle b ( 3, 2, 1, 0 )
    b3.v  = _mm256_shuffle_pd( b2.v, b2.v, 0x5 );

    c_max.v = _mm256_max_pd( a03.v  , b3.v    );
    c_min.v = _mm256_min_pd( a03.v  , b3.v    );
    c_max.v = _mm256_sub_pd( c_max.v, c_min.v );
    c03_3.v = _mm256_add_pd( c_max.v, c03_3.v );

    c_max.v = _mm256_max_pd( a47.v  , b3.v    );
    c_min.v = _mm256_min_pd( a47.v  , b3.v    );
    c_max.v = _mm256_sub_pd( c_max.v, c_min.v );
    c47_3.v = _mm256_add_pd( c_max.v, c47_3.v );
